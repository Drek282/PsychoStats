...
The Firearms heatmaps have not all been tested, some are working as intended, some are not matching up with the data and I have been unable to ascertain why.  Some of the heatmap images also show little or no detail.
